...
// Fö komponens
export default function OverworldEncyclopedia() {
    // Dinamikus színek
    const bgCard = useColorModeValue("white", "gray.700");
    const textColor = useColorModeValue("gray.800", "white");
    const accentGradient = useColorModeValue("linear(45deg, green.400, teal.500)", "linear(45deg, green.300, teal.400)");
    const skillBg = useColorModeValue("green.50", "green.900");
    ...
    const bossBorder = useColorModeValue("teal.200", "teal.600");
    const bossHeaderGradient = useColorModeValue("linear(45deg, teal.300, teal.500)", "linear(45deg, teal.500, teal.700)");
    const gridBg = useColorModeValue("teal.50", "teal.800");
    const bossAnalysisBg = useColorModeValue("rgba(255,255,255,0.15)", "rgba(0,0,0,0.3)");
    const bossAnalysisTextColor = useColorModeValue("teal.500", "teal.300");
    ...
    return (
        <Box maxW="1400px" mx="auto" p={8} minH="100vh">
            ...
            <Flex direction="column" align="center" my={16} position="relative">
                ...
                >
                    <Box as={FaCrown} mr={2}/>
                    Overworld Portál Bemutatása
                </Heading>
            </Flex>

            {/* Játékos kártya */}
            <ResponsiveCard bg={bgCard} borderColor="green.300" my={12}>
                ...
                <Flex p={8} gap={12} align="center" direction={{base: 'column', md: 'row'}}>
                    <MotionBox animation={`${float} 3s ease-in-out infinite`} filter="drop-shadow(0 10px 8px rgba(0,0,0,0.3))">
                        <Image
                            src="/images/overworld_player.png"
                            alt="Karakter"
                            w="100%"
                            h="100%"
                            p={5}
                    ...
                    <Box flex={1}>
                        <Flex gap={12} mb={8} direction={{base: 'column', md: 'row'}}>
                            ...
                            <Flex align="center" gap={4}>
                                <Box as={FaDragon} color="green.400" boxSize={6}/>
                                <Box>
                                    <Text fontWeight="400" fontSize="1.25rem">2 Sebzés</Text>
                                </Box>
                            </Flex>
                        </Flex>
                        <Box bg={skillBg} p={5} borderRadius="1rem" borderLeft="4px solid" borderColor="green.400">
            ...
            <Box bg={bgCard} p={8} borderRadius="2rem" boxShadow="lg" mt={12}>
                ...
                {/* Képességek */}
                <ResponsiveCard bg={bgCard} borderColor="green.300" mb={8}>
                    ...
                    <Flex p={8} gap={12} align="center" direction={{base: 'column', md: 'row'}}>
                        ...
                        <Box flex={1}>
                            <Flex gap={12} mb={8} direction={{base: 'column', md: 'row'}}>
                                ...
                                <Flex align="center" gap={4}>
                                    <Box>
                                        <Text fontWeight="400" fontSize="2rem">Slime</Text>
                                    </Box>
                                </Flex>
                                ...
                                <Flex align="center" gap={4}>
                                    <Box as={FaHeart} color="teal.500" boxSize={6}/>
                                    <Box>
                                        <Text fontWeight="400" fontSize="1.25rem">2 Élet</Text>
                                    </Box>
                                </Flex>
                                <Flex align="center" gap={4}>
                                    <Box as={FaDragon} color="green.400" boxSize={6}/>
                                    <Box>
                                        <Text fontWeight="400" fontSize="1.25rem">1 Sebzés</Text>
                                    </Box>
                                </Flex>
                            </Flex>
                            <Box position="relative" bg={bossAnalysisBg} p={6} borderRadius="1rem">
                                ...
                                <Text fontSize="1.25rem">A Slime egy kocsonyás, amorf teremtmény, amely leginkább egy élö, lüktetö masszára hasonlít. Élénk kék színben található meg a világban.</Text>
                            </Box>
                        </Box>
                    </Flex>
                </ResponsiveCard>
                    ...
                    <Flex p={8} gap={12} align="center" direction={{base: 'column', md: 'row'}}>
                        ...
                        <Box flex={1}>
                            <Flex gap={12} mb={8} direction={{base: 'column', md: 'row'}}>
                                ...
                                <Flex align="center" gap={4}>
                                    <Box>
                                        <Text fontWeight="400" fontSize="2rem">Medium Slime</Text>
                                    </Box>
                                </Flex>
                                ...
                                <Flex align="center" gap={4}>
                                    <Box as={FaHeart} color="teal.500" boxSize={6}/>
                                    <Box>
                                        <Text fontWeight="400" fontSize="1.25rem">5 Élet</Text>
                                    </Box>
                                </Flex>
                                <Flex align="center" gap={4}>
                                    <Box as={FaDragon} color="green.400" boxSize={6}/>
                            ...
                            <Box position="relative" bg={bossAnalysisBg} p={6} borderRadius="1rem">
                                ...
                                <Text fontSize="1.25rem" textAlign={"justify"}>A Medium Slime egy nagyobb és veszélyesebb változata az egyszerü Slime-oknak, amely már nem csupán egy kis kocsonyás lény, hanem egy aktív és agresszív ragadozó. Mérete általában egy ember fejéig ér, és sürübb, erösebb anyagból áll, amely ellenállóbb a fizikai támadásokkal szemben. Kicsivel lassabb, mint kisebb társai.</Text>
                            </Box>
                        </Box>
                    </Flex>
                </ResponsiveCard>
            ...
            {/* Főellenség */}
            <ResponsiveCard bg={bossBg_green} borderColor={bossBorder} mt={16}>
                <Box bgGradient={bossHeaderGradient} p={8} textAlign="center">
                    <Heading fontSize="1.75rem" color="white">
                        <FaCrown fontSize={50}/> Főellenség : Slime Lord
                    </Heading>
                </Box>
                <Flex p={8} gap={12} align="center" direction={{base: 'column', md: 'row'}}>
                    <MotionBox animation={`${float} 3s ease-in-out infinite`}
                    ...
                    <Box flex={1}>
                            ...
                            <Grid templateColumns="repeat(auto-fit, minmax(200px, 1fr))" gap={6}>
                                <Box bg={gridBg} p={4} borderRadius="1rem">
                                    <Flex align="center" gap={4}>
                                        ...
                                        <Box>
                                            <Text fontWeight="400" fontSize="1.25rem">50 Élet</Text>
                                        </Box>
                                    </Flex>
                                </Box>
                                <Box bg={gridBg} p={4} borderRadius="1rem">
                        ...
                        <Box position="relative" bg={bossAnalysisBg} p={6} borderRadius="1rem">
                            ...
                            <Text fontSize="1.25rem">A világ föellensége. Sokkal lassabb és nagyobb, mint társai. Erösebb támadása van, mint akármelyik másik slimenak. A Slime Lord egy ösi, hatalmas nyálkaszörny, amely a Slime-ok fejlödésének csúcsát képviseli.</Text>
                        </Box>
                    </Box>
                </Flex>
            </ResponsiveCard>
